...
class PostListViewTests(APITestCase):
    ...
    def test_can_list_posts(self):
        ...
        Post.objects.create(owner=sophie, title='a title')
...
class PostDetailViewTests(APITestCase):
    def setUp(self):
        ...
        Post.objects.create(
            owner=sophie, title='a title', description='sophies description'
        )
        Post.objects.create(
            owner=stefan, title='another title', description='stefans description'
        )
