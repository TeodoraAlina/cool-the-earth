        ...
        <Row>
          <Col xs={12} md={3} lg={3}>
            ...
            <ul className="list-unstyled">
              <li className={styles.Contact}>
                <a href="mailto:info@cooltheearth.com"><i className="fa-solid fa-envelope"></i>Email: info@cooltheearth.com</a>
              </li>
              <li className={styles.Contact}>
                <a href="tel:06763459834"><i className="fa-solid fa-phone"></i>Phone: 06763459834</a>
              </li>
            </ul>
          </Col>
          <Col xs={12} md={3} lg={3}>
            ...
            <ul className="list-unstyled">
              ...
              <li>
                <a href="https://twitter.com/"><i className="fa-brands fa-square-x-twitter"></i>Twitter</a>
              </li>
              <li>
          ...
          <Col xs={12} md={3} lg={6} className="text-center text-md-right">
            <div className={styles.LogoCopyrightContainer}>
              ...
              <p className={styles.CopyrightText}>&copy; {new Date().getFullYear()} Cool the Earth. All rights reserved.</p>
            </div>
          </Col>
        </Row>
      </Container>
